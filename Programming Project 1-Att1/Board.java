...
public class Board {
	...
	public static void endStatement (int currentState, int playing)
	{
		if (currentState == X_WON && playing == USER ) {
			System.out.println("Congratulations, you won!");
		}
		else if (currentState == X_WON && playing == COMPUTER) {
			System.out.println("Sorry, Computer won.");
		}
		else if (currentState == O_WON && playing == USER ) {
			System.out.println("Congratualtions, you won!");
		}
		else if (currentState == O_WON && playing == COMPUTER) {
			System.out.println("Sorry, Computer won.");
		}
		else if (isDraw() == true) {
			System.out.println("Draw! No winner.");
